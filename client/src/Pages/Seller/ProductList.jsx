...
const toggleStock = async (id, inStock) => {
    console.log(`Frontend: Attempting to update product ${id} to inStock: ${inStock}`);
    try {
        ...
        if (data.success) {
            ...
            console.error("Frontend: API reported failure:", data);
            toast.error(data.message);
        }
    } catch (error) {
        console.error("Frontend: Error in API call:", error);
