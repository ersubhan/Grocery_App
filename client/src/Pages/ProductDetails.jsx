    ...
    product && (
      <div className="mt-24">
        ...
        <div className="flex flex-col items-center mt-20">
          ...
          <button onClick={()=> {navigate('/products'); scrollTo(0,0)}} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary-dull transition">See More</button>
        </div>
      </div>
    )
  );
